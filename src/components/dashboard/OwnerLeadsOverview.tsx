...
const OwnerLeadsOverview = () => {
  ...
  const handleEditClick = (lead: Lead) => {
    ...
    setEditingAssignee(lead.assigned_to || "");
    ...
    try {
      const { error } = await supabase
        ...
        .update({
          ...
          assigned_to: editingAssignee || null,
        })
      ...
      if (error) {
        ...
        setLeads(leads.map(lead => 
          lead.id === selectedLead.id 
            ? { ...lead, status: editingStatus as any, assigned_to: editingAssignee }
            : lead
        ));
                      ...
                      <div className="flex justify-center gap-2">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem onClick={() => handleEditClick(lead)}>Reassign</DropdownMenuItem>
                          </DropdownMenuContent>
                        </DropdownMenu>
                      </div>
                    </td>
          ...
          {selectedLead && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-foreground mt-1">{getAssigneeName(selectedLead.assigned_to)}</p>
              </div>
            </div>
          )}
          <DialogFooter>
...
export default OwnerLeadsOverview;
